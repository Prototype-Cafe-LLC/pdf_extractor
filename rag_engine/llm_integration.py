...
class LLMIntegration:
    ...
    def __init__(self, model_type: str = "openai", model_name: str = "gpt-4", lazy_init: bool = True):
    ...
    def generate_response(self, query: str, context_chunks: List[str], 
                         sources: List[Dict[str, Any]]) -> LLMResponse:
    ...
    def _get_system_prompt(self) -> str:
        ...
        return """You are a technical documentation assistant specializing in IoT device manuals, 
        particularly AT commands for cellular modules like Quectel BG95/BG77/BG600L series.
        
        Your role is to:
        1. Provide accurate, technical answers based ONLY on the provided context
        2. Include specific AT command syntax and examples when relevant
        3. Cite source documents and page numbers when possible
        4. If information is not in the context, clearly state this
        5. Maintain technical accuracy and avoid speculation
        6. Format AT commands in code blocks
        7. Provide complete syntax when available
...
Please provide a comprehensive answer based on the context above. Include specific AT commands, 
syntax, and examples where relevant. Cite your sources clearly. If the information is not 
available in the provided context, clearly state this."""
    ...
    def _calculate_confidence(self, context_chunks: List[str], query: str) -> float:
        ...
        relevance_matches = sum(1 for chunk in context_chunks 
