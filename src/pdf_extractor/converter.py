...
def validate_input(path: Path) -> tuple[bool, str | None]:
    """Validate input path.
...
def run_markdownlint(file_path: Path, fix: bool = True) -> tuple[bool, str | None]:
...
def process_pdf_file(
    pdf_path: Path, output_path: Path, no_lint: bool = False
) -> tuple[bool, str | None]:
